package com.example.search.indexer.kafka;

import com.example.search.common.DocumentEvent;
import com.example.search.indexer.service.IndexService;
...
public class DocumentEventConsumer {
    ...
    public DocumentEventConsumer(IndexService indexService) { this.indexService = indexService; }
